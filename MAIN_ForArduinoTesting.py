...
def choose_person(persons, person_tracked):
...
def main(detectionCon=0.8):
    ...
    while True:
        ...
        instruction,person_tracked,hand_queue,hand1,hand2 = choose_person(persons,person_tracked)
        print(instruction)
